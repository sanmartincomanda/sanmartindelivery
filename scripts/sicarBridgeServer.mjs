...
server.listen(bridgeConfig.bridgePort, bridgeConfig.bindHost, () => {
  ...
  if (IS_PRIMARY_GLOBAL_SYNC_BRANCH) {
    ...
    console.log(
      `Procesos globales de clientes, recompensas, cupones y archivo reservados para granada; ${bridgeConfig.branchId} ejecuta solo cotizaciones SICAR.`
    );
  }
  if (ENABLE_SICAR_QUOTE_SYNC) {
